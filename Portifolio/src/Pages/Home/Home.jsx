  ...
  return (
    <>
        ...
        <main className='flex flex-col items-center gap-5'>
            <span className='w-14 h-2 rounded shadow bg-[#CBCBCB] mb-4'></span>
            

            {/* seção sobre */}
            <section id='sobre' className='flex flex-col justify-center items-center gap-15  my-8 w-full' >
                <div className='flex items-start gap-8'>
                    <h1 className='text-5xl rotate-270 font-black text-white '>
                        SO<br/>
                        BRE<span className='text-[#1ED760]'>.</span>
                    </h1>
                    <p className='break-words max-sm:w-fit w-[50rem] text-[#929292] font-bold leading-8'>Nesta seção eu descrevo um pouco de mim. Como me vejo no quesito habilidades e também se tratando de comportamento organizacional.</p>
                </div>
                ...
                <div className='flex max-sm:flex-col  flex-row justify-between w-full max-sm:gap-0 gap-5'>
                    ...
                    <div className='w-full h-96 relative'>
                        ...
                        <div className='w-full h-96 max-sm:h-fit max-sm:py-8 relative flex flex-col items-center'>
                            ...
                            <p className='mt-24 ml-28 max-sm:ml-0  max-sm:leading-6 break-words w-[30rem] max-sm:w-[20rem] text-[#929292] leading-9 '>Me considero participativo e comunicativo em equipe. De facíl adaptação, consigo me integrar a rotina e fazer parte do processo.</p>
                        </div>
                    </div>
                </div>
            </section>
